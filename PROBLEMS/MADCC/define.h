...
// mad code comparison diagnostics
#define SIMOUTPUT 5
//#define SIMOUTPUT_PHIAVG
//#define SIMOUTPUT_PHICORR
//#define SIMOUTPUT_FLUXES // use this instead of scalars for code comparison
#define SIMOUTPUT_RADPROF // use this instead of RADOUTPUT
