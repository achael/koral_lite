...
#define RMIN_DISK 1000.//100. //ROUT //special definition used in BC
#define SPECIAL_BC_CHECK
#define STREAM_IX 84//74
#define STREAM_IYT 88
#define STREAM_IYB 103
...
//dM/deps function parameters
#define F_S -3.
#define F_XOFF -1.
#define MASSRESCALE 2. //scale mass to get desired injected mass

//Inputs for stream (can use stellar properties defined above)
#define EPSILON0 -2.*DEPSILON//EPSILON_MIN//-2.15e-3 //Base epsilon for model, defines t_fb
